        ...
        <div class='flex justify-center items-center w-screen h-screen'>
            <form class='flex p-10 flex-col w-2/4 bg-white rounded-lg' name="CadLab" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div>
                    ...
                    <label class='mr-4'>
                        CPF <input type="radio" name="novoValor" value="cpf">
                    </label>
                </div>
                ...
                <br>
                <input class='rounded-full w-auto h-9 mt-5 bg-green-400 text-white hover:bg-green-300 cursor-pointer' type="submit" name="AltCadPac" value="Alterar Dados" onclick="send_form()">
            </form>
        </div>
    </body>
</html>