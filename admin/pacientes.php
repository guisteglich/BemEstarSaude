        ...
        <div class="flex flex-col mx-5 w-full h-screen">
            ...
            <div class="mt-3 mb-2 w-full h-full bg-white rounded-md p-6 overflow-auto">
                <div class="flex flex-row items-center">
                    <!-- Cadastro e busca -->
                    <button class='rounded-md w-24 h-8 bg-green-400 hover:bg-green-500 text-white hover:cursor-pointer'><a href="../admin/cadastro_pacientes.php">Cadastrar</a></button>
                    <button class='ml-2 w-auto h-8 px-4 bg-yellow-400 hover:bg-yellow-500 rounded-md text-white'><a href='../admin/alterar_cad_paciente.php'>Alterar Paciente</a></button>
                </div>
